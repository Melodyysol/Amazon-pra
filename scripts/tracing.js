...
import dayjs from 'https://unpkg.com/dayjs@1.11.10/esm/index.js'
  ...
  function renderTrackingGrid() {
    ...
    order.products.forEach(details => {
      ...
      const isDeliveringOn = today >= deliveryTime ? 'Delivered on' :'Arriving on'
      ...
      trackingHTML = `
        ...
        <div class="delivery-date">
          ${isDeliveringOn} ${dayjs(productDetails.estimatedDeliveryTime).format('dddd, MMMM D')}
        </div>
      ...
      `
    document.querySelector('.js-cart-quantity').innerHTML = productDetails.quantity
